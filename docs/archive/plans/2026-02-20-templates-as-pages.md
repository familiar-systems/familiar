...
- **[Template Authoring & Import Format](2026-06-25-template-authoring-and-import-format.md)** - how templates are authored on disk (per-locale markdown) and imported into a campaign as `template` pages, including instantiation (`from_template_id` cloning) and born-with-templates campaign creation.
