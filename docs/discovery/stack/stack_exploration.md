...
This document evaluates technology stacks for Loreweaver before any code is written. It sits alongside the [storage analysis](../storage/storage_overview.md) (PostgreSQL or Turso) and the [audio pipeline design](../audio_ingest/audio_overview.md) (multi-stage AI processing).
