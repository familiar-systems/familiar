...
#
# Secrets (registry pull, internal bearer) are managed by External Secrets
# Operator in-cluster. This script only templates non-secret per-PR
# variables (namespace, images, Hanko URL).
#
...
for secret in scaleway-registry internal-bearer; do
