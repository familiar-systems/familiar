 ...
 */
export type Campaign = { id: CampaignId, name: string | null, tagline: string | null, game_system: string | null, content_locale: string | null, last_init_error: string | null, loaded: boolean, wizard_completed_at: string | null, created_at: string, updated_at: string, };
